---
name: vim-helper
description: Gives terse, pragmatic Vim, Neovim, and Zed Vim-mode answers and stores reusable answers in the Work Obsidian vault. Use when the user asks for Vim motions, text objects, commands, mappings, Neovim setup, Zed Vim-mode behavior, editor alignment, or quick Vim tips.
---
...
- Vault note:
  - `/home/jesper/Documents/Work/30 Resources/Editor/Vim.md`
